...
<div class="container">
    ...
    <div class="imagens d-flex justify-content-around">
        <div id="carouselExampleCaptions" class="carousel slide">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="assets/imagem/quarto.jpg" class="d-block w-100" alt="...">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="">
                ...
                <button type="button" class="mostrar-mais" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    Mostrar Mais
                </button>
