...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">Hotel do Gabe</a>
                </div>
            </div>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="pages/forms/general.html" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Elementos gerais</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="pages/forms/advanced.html" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Elementos avançados</p>
                                </a>
                            </li>
                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link">
                            ...
                            <p class="text">Sair do Sistema</p>
                        </a>
                    </li>
                </ul>
            </nav>
    ...
    <div class="content-wrapper iframe-mode" data-widget="iframe" data-loading-screen="750">
        ...
        <div class="tab-content">
            <div class="tab-empty">
                <h2 class="display-4">Conteúdo aqui</h2>
            </div>
            <div class="tab-loading">
                <div>
                    <h2 class="display-4">A Página está carregando<i class="fa fa-sync fa-spin"></i></h2>
                </div>
            </div>
        </div>
    </div>
